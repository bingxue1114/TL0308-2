...
(function() {
    ...
    let countup = select('.countup');

    const countUpDate = function() {
        let timeleft = new Date().getTime() - new Date(countup.getAttribute('data-count')).getTime();
